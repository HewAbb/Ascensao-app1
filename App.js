        ...
        <View style={styles.container}>
          ...
          <View style={styles.characterCard}>
            <View style={styles.avatarCircle}>
              <Ionicons name="person" size={25} color="#B69BFF" />
            </View>
            <View style={styles.characterInfo}>
              <Text style={styles.characterName}>{state.player.name}</Text>
              <Text style={styles.characterTitle}>ASCENDENTE</Text>
            </View>
            <View style={styles.characterLevel}>
              <Text style={styles.characterLevelText}>NÍVEL {levelInfo.level}</Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={styles.streakHero}>
              <View style={styles.streakFlame}>
                <Ionicons name="flame" size={86} color="#9A6CFF" />
